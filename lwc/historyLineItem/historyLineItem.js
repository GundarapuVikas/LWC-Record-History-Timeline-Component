...
export default class HistoryLineItem extends LightningElement {
    ...
    @api editFieldLabel;
    timeLineClassToggle;
    timeLineClassName='slds-timeline__item_expandable slds-timeline__item_event ';
    ...
    updateTimeLineClass(){
        if(!this.timeLineClassToggle){
            ...
            this.timeLineClassName='slds-timeline__item_expandable slds-timeline__item_event ';
